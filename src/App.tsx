    ...
    <>
      ...
      >
        <ImgMediaCard
          ...
          img="/маникюр.png"
          alt="маникюр коптево"
          description="Расслабьтесь и дайте своим ногтям гламурный вид с нашим ногтевым сервисом в салоне красоты! Наши опытные мастера сделают вашу маникюр и педикюр безупречными, используя только самые качественные материалы. Приходите в наш салон и получите заряд уверенности и красоты для ваших ногтей!"
        />
        <ImgMediaCard
          price={manPrice()}
          ...
          description="Устали от однообразных стрижек? Приходите к нам на мужские стрижки и доверьтесь нашим профессиональным стилистам! Независимо от типа волос и желаемого стиля, мы создадим идеальную стрижку, которая подчеркнет вашу мужественность и индивидуальность. Запишитесь на прием уже сегодня и насладитесь первоклассным обслуживанием!"
        />
        <ImgMediaCard
          price={womanPrice()}
          ...
          alt="стрижка коптево"
          description="Хотите обновить свой образ? Приходите к нам на женские стрижки и доверьтесь нашим опытным стилистам! Независимо от того, стилируете ли вы короткие прически или длинные локоны, мы поможем вам найти идеальную стрижку, которая подчеркнет вашу индивидуальность и стиль. Запишитесь на прием уже сегодня и ощутите, как ваша красота расцветает!"
        />
        <ImgMediaCard
          price={colorPrice()}
          service="Окрашивания"
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "50px" }}>
          <BasicCard
            img="/стрижка.png"
            alt="салон красоты"
            description="Одним из главных преимуществ нашего салона красоты являются наши профессиональные мастера. Они обладают богатым опытом и знаниями, позволяющими предоставить нашим клиентам высококачественные услуги по уходу за волосами, макияжу и маникюру. Каждый мастер умеет подчеркнуть индивидуальные черты и красоту каждого клиента, создавая неповторимые образы."
          />
          <BasicCard
            img="/кошелек.png"
